            ...
            <div class="container">
              <div class="lgx-footer-area">
                <div class="lgx-footer-single">
                  <a class="logo" href="index.html"><img src="{{ asset ('fe/assets/img/newinnov8.png')}}" alt="Logo" /></a>
                </div>
                <!--//footer-area-->
                <div class="lgx-footer-single">
                  <h3 class="footer-title">Venue Location</h3>
                  <h4 class="date">23 - 25 November, 2024</h4>
                  <address>Gyan Bhawan, Patna, Bihar</address>
              ...
              <div class="lgx-footer-bottom">
                <div class="lgx-copyright">
                  <p><span>©</span> 2024 Event is powered by <a href="#">Startup Bihar</a></p>
                </div>
              </div>
            </div>
            <!-- //.CONTAINER -->
